...
window.mockData = {
    ...
    diaryEntries: [
        ...
        {
            id: 'd5',
            title: '古罗马掠影：竞技场的荣耀与残酷',
            date: '公元100年',
            content: '身临其境感受了罗马竞技场的震撼，观众的呐喊声震耳欲聋，角斗士的生死搏斗令人心悸。罗马帝国的强大与辉煌，建立在铁血征服和奴隶制度之上。看到了维苏威火山爆发前的庞贝城，繁华背后隐藏着自然的力量。这个时代充满了矛盾与史诗感。',
            tags: ['历史', '古罗马', '战争'],
            emotion: 'awed', // 敬畏
            theme: '历史文明'
        },
        {
            ...
            title: '探索深海：未知的生命与奇观',
            date: '2050-08-10',
            content: '乘坐最新的深海潜艇，下潜到万米深渊。见到了前所未见的深海生物，它们在极端压力下展现出惊人的生命力。海底热液喷口周围的生态系统，如同另一个星球。深海，是地球上最后的未知领域，充满了无限的可能和挑战。',
            tags: ['科幻', '深海', '生物', '未来'],
            emotion: 'curious', // 好奇
            theme: '宇宙探索'
        },
        {
            id: 'd7',
            title: '中世纪欧洲：城堡与骑士的传说',
            date: '1250-05-01',
            content: '回到了中世纪的欧洲，体验了骑士训练和城堡生活。生活节奏缓慢，但信仰的力量无处不在。黑死病的阴影笼罩，但人们依然坚韧地生活。这是一个充满浪漫与苦难并存的时代。',
            tags: ['历史', '中世纪', '骑士'],
            emotion: 'pensive', // 沉思
            theme: '历史文明'
        },
        {
            ...
            title: '量子计算突破：思维的极限',
            date: '2099-01-01',
            content: '见证了量子计算机的重大突破，它能够在一瞬间完成传统计算机千年才能完成的计算。这将彻底改变科学研究、医疗和人工智能的未来。但同时也带来了伦理和社会问题，人类准备好迎接这样的变革了吗？',
            tags: ['未来', '科技', '量子计算'],
            emotion: 'thoughtful', // 深思
            theme: '未来科技'
        }
    ],
    feedback: [
